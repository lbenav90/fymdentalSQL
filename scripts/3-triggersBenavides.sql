...
-- Trigger que al agregar una evolucion con un tratamiento que tenga el parametro trabajo_laboratorio = 1, llama a un stored procedure que crea el nuevo trabajo de laboratorio
-- y actualiza la evolucion con el id que acaba de crear

-- Genera logs de evoluciones

-- Genera logs de pagos
