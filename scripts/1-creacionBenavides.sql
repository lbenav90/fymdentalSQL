...
CREATE TABLE IF NOT EXISTS pagos (
	id_pago	INT	NOT NULL UNIQUE PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS log_pagos (
	id_log_pagos INT NOT NULL UNIQUE PRIMARY KEY AUTO_INCREMENT,
    fecha DATE NOT NULL DEFAULT (CURDATE()),
...
CREATE TABLE IF NOT EXISTS pagos_audit (
	id_changed_log INT,
    old_row	VARCHAR(1000),
    new_row	VARCHAR(1000),
    FOREIGN KEY (id_changed_log)
		REFERENCES log_pagos (id_log_pagos)
);

CREATE TABLE IF NOT EXISTS log_evoluciones (
	id_log_evoluciones INT NOT NULL UNIQUE PRIMARY KEY AUTO_INCREMENT,
    fecha DATE NOT NULL DEFAULT (CURDATE()),
    hora TIME NOT NULL DEFAULT (CURTIME()),
    evento VARCHAR(20) NOT NULL,
    objetivo INT NOT NULL,
